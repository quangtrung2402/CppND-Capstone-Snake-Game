...
void Snake::Up() {
  if (direction != Snake::Direction::kDown || score == 0)
    direction = Snake::Direction::kUp;
}

void Snake::Down() {
  if (direction != Snake::Direction::kUp || score == 0)
    direction = Snake::Direction::kDown;
}

void Snake::Left() {
  if (direction != Snake::Direction::kRight || score == 0)
    direction = Snake::Direction::kLeft;
}

void Snake::Right() {
  if (direction != Snake::Direction::kLeft || score == 0)
